...
extern off_t (*WRAP(lseek))(int fd, off_t offset, int whence);

extern int(*WRAP(sigwait))(const sigset_t *, int *);

// pthread basics
extern int(*WRAP(pthread_create))(pthread_t *, const pthread_attr_t *,
                                  void *(*)(void *), void *);
...
extern int(*WRAP(pthread_mutex_init))(pthread_mutex_t *,
...
// pthread barriers
extern int(*WRAP(pthread_barrier_init))(pthread_barrier_t *,
